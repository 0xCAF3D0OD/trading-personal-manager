...
import { runMarketSlippage, runPortfolioDaily, runScanDiscover, runScanEvaluate, runScanMaintenance, runScanRetro, runWatchMaintenance, runWatchNews, runWatchOnchain, runWatchPages, runWatchReview } from './watch.jobs.js';
...
export class Scheduler {
  ...
  start(): void {
    ...
    schedule('portfolio-daily', wj['portfolio-daily']!, runPortfolioDaily);
